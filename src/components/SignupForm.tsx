...
export default function SignupForm(){
    ...
    <div className="mb-50 ml-50 mr-50 text-[#000000]">
        <input type="text" placeholder="email" className="py-3 px-10 rounded" required maxLength={50}></input>
    </div>
    <div className="mb-10 ml-50 text-[#000000]">
        <input type="password" placeholder="password" className="py-3 px-10 rounded" required maxLength={16}></input>
    </div>
